...
const PIECE_TYPES = {
    ...
    PRISM: 'prism',                        // △
    COMBINER: 'combiner',                  // ◇
    FILTER_RED: 'filter_red',              // R
    FILTER_GREEN: 'filter_green',          // G
    FILTER_BLUE: 'filter_blue',            // B
    SPLITTER: 'splitter',                  // ┼
...
const LEVELS = {
    ...
    'w1_l1': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.RED }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 }
        ],
        parMoves: 2
    },
    'w1_l2': {
        ...
        gridSize: { width: 4, height: 4 },
        sources: [
            { id: 's1', position: { x: 0, y: 3 }, direction: 'up', color: COLORS.GREEN }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 1 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 1 }
        ],
        parMoves: 2
    },
    'w1_l3': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.BLUE }
        ],
        targets: [
        ...
        availablePieces: [
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
        parMoves: 4
    },
    'w1_l4': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 1 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.GREEN }
        ],
        targets: [
    ...
    'w1_l5': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.CYAN }
        ],
        targets: [
    ...
    'w1_l6': {
        ...
        gridSize: { width: 5, height: 4 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.YELLOW }
        ],
        targets: [
        ...
        lockedCells: [],
        preplacedPieces: [
            { position: { x: 2, y: 1 }, piece: { type: PIECE_TYPES.MIRROR_FORWARD, rotation: 0 } }
        ],
        availablePieces: [
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 1 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
    ...
    'w1_l7': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 4, y: 2 }, direction: 'left', color: COLORS.BLUE }
        ],
        targets: [
    ...
    'w1_l8': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.MAGENTA }
        ],
        targets: [
    ...
    'w1_l9': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 1 }, direction: 'right', color: COLORS.GREEN }
        ],
        targets: [
    ...
    'w1_l10': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
        ...
        preplacedPieces: [
            { position: { x: 4, y: 0 }, piece: { type: PIECE_TYPES.MIRROR_FORWARD, rotation: 0 } }
        ],
        availablePieces: [
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 3 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 3 }
        ],
        parMoves: 5
    },
    ...
    'w2_l1': {
        ...
        gridSize: { width: 5, height: 4 },
        sources: [
            { id: 's1', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.WHITE }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.PRISM, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
        parMoves: 1
    ...
    'w2_l2': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.RED },
            { id: 's2', position: { x: 4, y: 0 }, direction: 'down', color: COLORS.GREEN }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.COMBINER, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
        parMoves: 5
    ...
    'w2_l3': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.GREEN },
            { id: 's2', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.BLUE }
        ],
        targets: [
    ...
    'w2_l5': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 4 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
    ...
    'w2_l6': {
        ...
        gridSize: { width: 6, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
    ...
    'w2_l7': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.RED },
            { id: 's2', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.GREEN },
            { id: 's3', position: { x: 4, y: 0 }, direction: 'down', color: COLORS.BLUE }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.COMBINER, count: 2 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 3 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 3 }
        ],
        parMoves: 6
    ...
    'w2_l8': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 4 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.PRISM, count: 2 },
            { type: PIECE_TYPES.COMBINER, count: 2 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
    ...
    'w2_l9': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 2, y: 2 }, direction: 'up', color: COLORS.WHITE }
        ],
        targets: [
        ...
        availablePieces: [
            { type: PIECE_TYPES.PRISM, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 4 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 4 }
        ],
        parMoves: 7
    },
    'w2_l10': {
    ...
    'w3_l1': {
        ...
        gridSize: { width: 4, height: 4 },
        sources: [
            { id: 's1', position: { x: 0, y: 1 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.FILTER_RED, count: 1 }
        ],
        parMoves: 1
    },
    'w3_l2': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.WHITE },
            { id: 's2', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.WHITE },
            { id: 's3', position: { x: 4, y: 0 }, direction: 'down', color: COLORS.WHITE }
        ],
        targets: [
            { id: 't1', position: { x: 0, y: 4 }, requiredColor: COLORS.RED },
        ...
        availablePieces: [
            { type: PIECE_TYPES.FILTER_RED, count: 1 },
            { type: PIECE_TYPES.FILTER_GREEN, count: 1 },
            { type: PIECE_TYPES.FILTER_BLUE, count: 1 }
        ],
        parMoves: 3
    },
    'w3_l3': {
    ...
    'w3_l6': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.WHITE },
            { id: 's2', position: { x: 4, y: 0 }, direction: 'down', color: COLORS.WHITE }
        ],
        targets: [
            { id: 't1', position: { x: 0, y: 4 }, requiredColor: COLORS.RED },
            { id: 't2', position: { x: 4, y: 4 }, requiredColor: COLORS.BLUE }
    ...
    'w3_l9': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 4 }, direction: 'right', color: COLORS.YELLOW }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.FILTER_RED, count: 2 },
            { type: PIECE_TYPES.COMBINER, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 3 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 3 }
        ],
    ...
    'w3_l10': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
    ...
    'w4_l1': {
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.SPLITTER, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
        parMoves: 3
    ...
    'w4_l2': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.GREEN }
        ],
        targets: [
    ...
    'w4_l3': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
            { id: 't1', position: { x: 4, y: 0 }, requiredColor: COLORS.BLUE },
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.SPLITTER, count: 2 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 3 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 3 }
        ],
        parMoves: 4
    ...
    'w4_l5': {
        ...
        gridSize: { width: 5, height: 5 },
        sources: [
            { id: 's1', position: { x: 2, y: 2 }, direction: 'up', color: COLORS.YELLOW }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.SPLITTER, count: 3 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 4 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 4 }
        ],
        parMoves: 6
    ...
    'w4_l10': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 5 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.SPLITTER, count: 4 },
            { type: PIECE_TYPES.COMBINER, count: 2 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 5 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 5 }
        ],
        parMoves: 8
    },
    ...
    'w5_l1': {
        ...
        availablePieces: [
            { type: PIECE_TYPES.TELEPORTER, count: 2 }
        ],
        parMoves: 2
    },
    'w5_l2': {
    ...
    'w5_l3': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 1 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
        ...
        teleporterPairs: [],
        availablePieces: [
            { type: PIECE_TYPES.TELEPORTER, count: 4 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 2 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 2 }
        ],
        parMoves: 6
    ...
    'w5_l5': {
        ...
        gridSize: { width: 6, height: 6 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.CYAN }
        ],
        targets: [
    ...
    'w5_l7': {
        ...
        gridSize: { width: 6, height: 6 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.MAGENTA }
        ],
        targets: [
            { id: 't1', position: { x: 5, y: 0 }, requiredColor: COLORS.MAGENTA },
    ...
    'w5_l9': {
        ...
        gridSize: { width: 6, height: 6 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.GREEN }
        ],
        targets: [
    ...
    'w6_l3': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 5 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
    ...
    'w6_l6': {
        ...
        gridSize: { width: 7, height: 6 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.YELLOW }
        ],
        targets: [
    ...
    'w6_l9': {
        ...
        sources: [
            { id: 's1', position: { x: 3, y: 3 }, direction: 'up', color: COLORS.WHITE }
        ],
        targets: [
            { id: 't1', position: { x: 0, y: 0 }, requiredColor: COLORS.RED },
        ...
        availablePieces: [
            ...
            { type: PIECE_TYPES.SPLITTER, count: 3 },
            { type: PIECE_TYPES.TELEPORTER, count: 2 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 6 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 6 }
        ],
        parMoves: 10
    },
    'w6_l10': {
        ...
        gridSize: { width: 7, height: 7 },
        sources: [
            { id: 's1', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 6, y: 3 }, direction: 'left', color: COLORS.WHITE }
        ],
        targets: [
        ...
        availablePieces: [
            { type: PIECE_TYPES.PRISM, count: 2 },
            { type: PIECE_TYPES.COMBINER, count: 3 },
            { type: PIECE_TYPES.SPLITTER, count: 2 },
            { type: PIECE_TYPES.TELEPORTER, count: 2 },
            { type: PIECE_TYPES.FILTER_RED, count: 1 },
            { type: PIECE_TYPES.FILTER_GREEN, count: 1 },
    ...
    'w7_l3': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 2, y: 0 }, direction: 'down', color: COLORS.GREEN },
            { id: 's3', position: { x: 4, y: 2 }, direction: 'left', color: COLORS.BLUE }
        ],
        targets: [
            { id: 't1', position: { x: 2, y: 4 }, requiredColor: COLORS.WHITE }
        ],
    ...
    'w7_l4': {
        ...
        gridSize: { width: 4, height: 5 },
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.CYAN }
        ],
        targets: [
    ...
    'w7_l6': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'down', color: COLORS.WHITE },
            { id: 's2', position: { x: 5, y: 0 }, direction: 'down', color: COLORS.WHITE }
        ],
        targets: [
    ...
    'w7_l7': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.GREEN },
            { id: 's3', position: { x: 0, y: 5 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
            { id: 't1', position: { x: 5, y: 1 }, requiredColor: COLORS.YELLOW },
            { id: 't2', position: { x: 5, y: 4 }, requiredColor: COLORS.MAGENTA }
    ...
    'w7_l9': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.CYAN },
            { id: 's2', position: { x: 0, y: 5 }, direction: 'right', color: COLORS.YELLOW }
        ],
        targets: [
    ...
    'w7_l10': {
        ...
        gridSize: { width: 7, height: 7 },
        sources: [
            { id: 's1', position: { x: 3, y: 0 }, direction: 'down', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.WHITE }
        ],
        targets: [
            { id: 't1', position: { x: 0, y: 0 }, requiredColor: COLORS.YELLOW },
    ...
    'w8_l4': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 0 }, direction: 'right', color: COLORS.RED },
            { id: 's2', position: { x: 0, y: 2 }, direction: 'right', color: COLORS.GREEN },
            { id: 's3', position: { x: 0, y: 5 }, direction: 'right', color: COLORS.BLUE }
        ],
        targets: [
    ...
    'w8_l9': {
        ...
        availablePieces: [
            ...
            { type: PIECE_TYPES.COMBINER, count: 1 },
            { type: PIECE_TYPES.SPLITTER, count: 2 },
            { type: PIECE_TYPES.TELEPORTER, count: 6 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 6 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 6 }
        ],
        parMoves: 12
    ...
    'w8_l10': {
        ...
        sources: [
            { id: 's1', position: { x: 0, y: 3 }, direction: 'right', color: COLORS.WHITE },
            { id: 's2', position: { x: 0, y: 4 }, direction: 'right', color: COLORS.WHITE },
            { id: 's3', position: { x: 7, y: 3 }, direction: 'left', color: COLORS.WHITE },
            { id: 's4', position: { x: 7, y: 4 }, direction: 'left', color: COLORS.WHITE }
        ],
        targets: [
            { id: 't1', position: { x: 0, y: 0 }, requiredColor: COLORS.RED },
        ...
        preplacedPieces: [],
        availablePieces: [
            { type: PIECE_TYPES.PRISM, count: 4 },
            { type: PIECE_TYPES.COMBINER, count: 4 },
            { type: PIECE_TYPES.SPLITTER, count: 4 },
            { type: PIECE_TYPES.TELEPORTER, count: 4 },
            { type: PIECE_TYPES.FILTER_RED, count: 1 },
            { type: PIECE_TYPES.FILTER_GREEN, count: 1 },
            { type: PIECE_TYPES.FILTER_BLUE, count: 1 },
            { type: PIECE_TYPES.MIRROR_FORWARD, count: 8 },
            { type: PIECE_TYPES.MIRROR_BACKWARD, count: 8 }
        ],
        parMoves: 15
    }
};
...
function getTotalPossibleStars() {
    return Object.keys(LEVELS).length * 3;
}
